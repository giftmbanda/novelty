...
// [get] route to get business idea.
/**
 * @swagger
 * /ideas/one/{id}:
 *  get:
 *     tags:
 *      - ideas
 *     summary: Gets a business idea by id
 *     description: This can only be done by users who have an idea.
 *     id: getUserById
 *     consumes:
 *        - application/json
 *     produces:
 ...
 *     responses:
 *        201:
 *         description: getting an idea.
 *        400:
 *         description: ideas or user do not exist.
 */
ideaRoute.get('/one/:id',async(req, res)=>{
    result =  await ideaController.getIdea(req.params);
